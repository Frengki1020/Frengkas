...
<div class="panel panel-default">
    <div class="panel-heading">
        View Service_hour    </div>

    <div class="panel-body">
                

        <form action="{{ url('/service_hours') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="hours" id="hours" class="form-control" value="{{$model['hours'] or ''}}" readonly="readonly">
            </div>
        </div>
